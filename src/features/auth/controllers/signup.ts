...
import { uploadToCloudinary } from '@global/helpers/cloudinaryUpload';
...
export class SignUpController {
  ...
  public async create(req: Request, res: Response): Promise<void> {
    const {
      body: { username, email, password, avatarColor, avatarImage }
    } = req;
    ...
    const result: UploadApiResponse = (await uploadToCloudinary(avatarImage, `${userObjectId}`, true, true)) as UploadApiResponse;
    if (!result?.public_id) {
